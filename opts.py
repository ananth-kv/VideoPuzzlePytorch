...
def parse_opts():
    ...
    parser.add_argument(
        '--root_path',
        default='/nfs1/datasets/UCF101',
        type=str,
        help='Root directory path of data')
    parser.add_argument(
        '--video_path',
        default='/nfs1/datasets/UCF101/UCF-101/videos',
        type=str,
        help='Directory path of Videos')
    parser.add_argument(
        '--annotation_path',
        default='/nfs1/code/ananth/code/Verisk/3D-ResNets-PyTorch/datasets/ucf101_01.json',
        type=str,
        help='Annotation file path')
    parser.add_argument(
        '--result_path',
        default='/nfs1/data/ananth/Verisk/results_puzzle/',
        type=str,
    ...
    parser.add_argument(
        ...
        default='ucf101',
        type=str,
        help='Used dataset (activitynet | kinetics | ucf101 | ucf101hmdb51)')
    parser.add_argument(
        '--n_classes',
        default=24,
        type=int,
    ...
    parser.add_argument(
        '--batch_size', default=30, type=int, help='Batch Size')
    parser.add_argument(
        '--n_epochs',
        default=100000,
        type=int,
    ...
    parser.add_argument(
        ...
        default='c3d',
        type=str,
        help='(resnet | preresnet | wideresnet | resnext | densenet | c3d')
    parser.add_argument(
        '--model_depth',
        default=18,
        type=int,
